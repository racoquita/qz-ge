...
var App = function() {
	...
	this.on = function() {
        ...
        if( this.hasTouch ) {
            ...
            $('li.item').on('click', that.touchItem);
            $('.wrapper .overlay .close').on('click', that.touchClose);
            $('.wrapper').on('click', that.touchBulletin);
        }
	}
	this.off = function() {
	...
	this.handleOne = function(id, onHover, run) {
		var snap = Snap(id);
	...
	this.handleTwo = function(id, onHover, run) {
		var snap = Snap(id);
	...
	this.handleThree = function(id, onHover, run) {
		var snap = Snap(id);
	...
	this.handleFour = function(id, onHover, run) {
		var snap = Snap(id);
	...
	this.handleFive = function(id, onHover, run) {
		var snap = Snap(id);
	...
	this.handleSix = function(id, onHover, run) {
		var snap = Snap(id);
