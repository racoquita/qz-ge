var App = function() {
	...
	var slides = [
		'<div class="f1 frame inactive"> \
				<div class="copy big"><img src="images/f1-copy.png" alt=""></div> \
				<div class="copy small"><img src="images/f1_copy_320.png" alt=""></div> \
				<div class="chart"> \
					<img class="f1-chart-a" src="images/f1-a_chart.png" alt=""> \
					<img class="f1-chart-b" src="images/f1-b_chart.png" alt=""> \
					<div class="f1-pagination-container"> \
						<a href="#" data-num="0" class="f1-pag selected"></a> \
						<a href="#" data-num="1" class="f1-pag"></a> \
					</div> \
				</div> \
				<a href="#" class="cta ixtrack" data-ix-category="external" target="_blank" data-ix-label="Read Bulletin" > \
					<img src="images/cta_text.png" alt="Read Bulletin on QZ.com "> \
				</a> \
		</div>',
		'<div class="f2 frame inactive"> \
			<div class="copy big"><img src="images/f2-copy.png" alt=""></div> \
			<div class="copy small"><img src="images/f2_copy_320.png" alt=""></div> \
			<div class="chart"><img src="images/f2_chart.png" alt=""></div> \
			<a href="#" class="cta ixtrack" target="_blank" data-ix-category="external" data-ix-label="Read Bulletin" ><img src="images/cta_text.png" alt="Read Bulletin on QZ.com "></a> \
		</div>'];
	this.on = function() {
		//that.setEvents();
